...
const SongSchema = CollectionSchema(
  ...
  indexes: {
    ...
    r'lyrics': IndexSchema(
      id: 337865269401772829,
      name: r'lyrics',
      unique: false,
      replace: false,
      properties: [
...
Song _songDeserialize(
  ...
  object.backgroundUrl = reader.readStringOrNull(offsets[1]);
  object.id = id;
...
extension SongQueryWhereSort on QueryBuilder<Song, Song, QWhere> {
  ...
  QueryBuilder<Song, Song, QAfterWhere> anyLyrics() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(
        const IndexWhereClause.any(indexName: r'lyrics'),
      );
    });
  }
}
...
extension SongQueryWhere on QueryBuilder<Song, Song, QWhereClause> {
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsEqualTo(String lyrics) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'lyrics',
        value: [lyrics],
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsNotEqualTo(String lyrics) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.between(
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsGreaterThan(
    String lyrics, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsLessThan(
    String lyrics, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsBetween(
    String lowerLyrics,
    String upperLyrics, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsStartsWith(
      String LyricsPrefix) {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.between(
        indexName: r'lyrics',
        lower: [LyricsPrefix],
        upper: ['$LyricsPrefix\u{FFFFF}'],
      ));
    });
  }

  QueryBuilder<Song, Song, QAfterWhereClause> lyricsIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addWhereClause(IndexWhereClause.equalTo(
        indexName: r'lyrics',
        value: [''],
  ...
  QueryBuilder<Song, Song, QAfterWhereClause> lyricsIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
            .addWhereClause(IndexWhereClause.lessThan(
...
extension SongQueryFilter on QueryBuilder<Song, Song, QFilterCondition> {
  QueryBuilder<Song, Song, QAfterFilterCondition> authorIsNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> authorIsNotNull() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlIsNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNull(
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlIsNotNull() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(const FilterCondition.isNotNull(
        property: r'backgroundUrl',
      ));
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlEqualTo(
    String? value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlGreaterThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlLessThan(
    String? value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlBetween(
    String? lower,
    String? upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'backgroundUrl',
        value: '',
  ...
  QueryBuilder<Song, Song, QAfterFilterCondition> backgroundUrlIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'backgroundUrl',
        value: '',
...
extension SongQuerySortBy on QueryBuilder<Song, Song, QSortBy> {
  ...
  QueryBuilder<Song, Song, QAfterSortBy> sortByBackgroundUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backgroundUrl', Sort.asc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> sortByBackgroundUrlDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension SongQuerySortThenBy on QueryBuilder<Song, Song, QSortThenBy> {
  ...
  QueryBuilder<Song, Song, QAfterSortBy> thenByBackgroundUrl() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backgroundUrl', Sort.asc);
    });
  }

  QueryBuilder<Song, Song, QAfterSortBy> thenByBackgroundUrlDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'backgroundUrl', Sort.desc);
    });
  }
...
extension SongQueryWhereDistinct on QueryBuilder<Song, Song, QDistinct> {
  ...
  QueryBuilder<Song, Song, QDistinct> distinctByBackgroundUrl(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension SongQueryProperty on QueryBuilder<Song, Song, QQueryProperty> {
  ...
  QueryBuilder<Song, String?, QQueryOperations> backgroundUrlProperty() {
    return QueryBuilder.apply(this, (query) {
