        ...
        for (int i = 0; i < slidesToExport.length; i++) {
          ...
          if (slide.isDualVersion && !slide.isSong) {
            ...
            generatedSlides.add(PowerpointSlideData(
              ...
              padLeft: settings.primaryVerseMarginLeft,
              padTop: settings.primaryVerseMarginTop,
              padRight: settings.primaryVerseMarginRight,
              padBottom: settings.primaryVerseMarginBottom,
              ...
              secondaryPadLeft: settings.secVerseMarginLeft,
              secondaryPadTop: settings.secVerseMarginTop,
              secondaryPadRight: settings.secVerseMarginRight,
              secondaryPadBottom: settings.secVerseMarginBottom,
              ...
              titlePadLeft: settings.dualChapterMarginLeft,
              titlePadTop: settings.dualChapterMarginTop,
              titlePadRight: settings.dualChapterMarginRight,
              titlePadBottom: settings.dualChapterMarginBottom,
              autoShrinkText: true,
              // Background
            ...
            generatedSlides.add(PowerpointSlideData(
              ...
              padLeft: settings.lyricsMarginLeft,
              padTop: settings.lyricsMarginTop,
              padRight: settings.lyricsMarginRight,
              padBottom: settings.lyricsMarginBottom,
              ...
              secondaryPadLeft: settings.lyricsMarginLeft,
              secondaryPadTop: settings.lyricsMarginTop,
              secondaryPadRight: settings.lyricsMarginRight,
              secondaryPadBottom: settings.lyricsMarginBottom,
              // Title styling
              ...
              titlePadLeft: settings.titleMarginLeft,
              titlePadTop: settings.titleMarginTop,
              titlePadRight: settings.titleMarginRight,
              titlePadBottom: settings.titleMarginBottom,
              autoShrinkText: true,
              // Background
            ...
            generatedSlides.add(PowerpointSlideData(
              ...
              padLeft: settings.verseMarginLeft,
              padTop: settings.verseMarginTop,
              padRight: settings.verseMarginRight,
              padBottom: settings.verseMarginBottom,
              ...
              titlePadLeft: settings.chapterMarginLeft,
              titlePadTop: settings.chapterMarginTop,
              titlePadRight: settings.chapterMarginRight,
              titlePadBottom: settings.chapterMarginBottom,
              autoShrinkText: true,
              // Background
